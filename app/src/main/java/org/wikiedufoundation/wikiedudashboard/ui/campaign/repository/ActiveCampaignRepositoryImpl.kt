 ...
 * */
class ActiveCampaignRepositoryImpl(private val wikiEduDashboardApi: WikiEduDashboardApi,
                                   private val activeCampaignDao: ActiveCampaignDao) : ActiveCampaignRepository {
     ...
     * */
    override suspend fun allCampaignList() = withContext(Dispatchers.IO) { activeCampaignDao.getAllCampaign() }


    /** The suspend modifier tells the compiler that this must be called from a
     *  coroutine or another suspend function.
     **/
    override suspend fun getCampaignList(cookies: String) = withContext(Dispatchers.IO) {
